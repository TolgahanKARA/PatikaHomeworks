...
public class Game {
    ...
    public void start() {
        ...
        while (true) {
            ...
            if (player.getInventory().getFirewood() == false
                    && player.getInventory().getFood() == false
                    && player.getInventory().getWater() == false) {

                System.out.println("Tüm Bölgeleri temizlediniz ve oyunu kazandınız TEBRİKLER");
                break;
